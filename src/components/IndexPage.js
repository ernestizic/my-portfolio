				...
				<div className='container'>
					<div className='row'>
						<div className='col-md-7 m-auto'>
							<h2 className='animate__animated animate__bounceInDown animate__fast'>
								Isaac Ifeanyichukwu Ernest
							</h2>
							<ReactTypingEffect
					...
					<div className='row'>
						...
						<div className='col-md-6 aboutme-texts'>
							...
							<p>
								...
								over 3 years of experience in writing maintainable and
								functional code following best practices, delivering responsive
								designs and applications that meets user's standard. I am an
								enthusiast and highly motivated learner.
							</p>
